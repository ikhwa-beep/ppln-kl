...
var simplemaps_countrymap_mapdata = {
	...
	// KL, Putrajaya, Selangor, Perak, Kelantan, Terengganu
	state_specific: {
		0: {},
		MYS1137: {
			name: "Perak",
			description: jsObject[0].perak, //getDataFunction("Perak"),
		},
		MYS1139: {
			name: "Pulau Pinang",
			description: 10, //getDataFunction("Pulau Pinang"),
		},
		MYS1140: {
			name: "Kedah",
			description: 10, //getDataFunction("Kedah"),
		},
		MYS1141: {
			name: "Perlis",
			description: 10, //getDataFunction("Perlis"),
		},
		MYS1143: {
			name: "Johor",
			description: 10, //getDataFunction("Johor"),
		},
		MYS1144: {
			name: "Kelantan",
			description: jsObject[0].kelantan, //getDataFunction("Kelantan"),
		},
		MYS1145: {
			name: "Melaka",
			description: 10, //getDataFunction("Melaka"),
		},
		MYS1146: {
			name: "Negeri Sembilan",
			description: 10, //getDataFunction("Negeri Sembilan"),
		},
		MYS1147: {
			name: "Pahang",
			description: 10, //getDataFunction("Pahang"),
		},
		MYS1148: {
			name: "Selangor",
			description: jsObject[0].selangor, //getDataFunction("Selangor"),
		},
		MYS1149: {
			name: "Terengganu",
			description: jsObject[0].terengganu, //getDataFunction("Terengganu"),
		},
		MYS1186: {
			name: "Sabah",
			description: 10, //getDataFunction("Sabah"),
		},
		MYS1187: {
			name: "Sarawak",
			description: 10, //getDataFunction("Sarawak"),
		},
		MYS4831: {
			name: "Kuala Lumpur",
			description: jsObject[0].kuala_lumpur, //getDataFunction("Kuala Lumpur"),
		},
		MYS4832: {
			name: "Putrajaya",
			description: jsObject[0].putrajaya, //getDataFunction("Putrajaya"),
		},
		MYS4833: {
			name: "Labuan",
			description: 10, //getDataFunction("Labuan"),
		},
	},
	locations: {},
	labels: {},
